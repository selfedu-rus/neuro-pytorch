...
class DigitNN(nn.Module):
    def __init__(self, input_dim, num_hidden, output_dim):
        ...
        self.layer2 = nn.Linear(num_hidden, output_dim)#bias =False
...
print("Вывод параметров сгенерированной модели с использованием словаря")
params=dict(model.named_parameters())
print(params)
for key, value in params.items():
    print(key, value)
#Выводим конфигурацию модели
print(model)
